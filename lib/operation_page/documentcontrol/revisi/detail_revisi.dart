    ...
    return SafeArea(
      child: Scaffold(
        ...
        floatingActionButton: Column(
          ...
          children: List.generate(_editCover ? iconsEdit.length : icons.length,
                  (int index) {
                  ...
                  child: ScaleTransition(
                    scale: CurvedAnimation(
                      ...
                      curve: Interval(
                          ...
                          1.0 -
                              index /
                                  (_editCover ? iconsEdit.length : icons.length) /
                                  2.0,
                    ...
                    child: FloatingActionButton(
                      heroTag: null,
                      tooltip: _editCover
                          ? iconsEditTooltip[index]
                          : iconsTooltip[index],
                      backgroundColor: backgroundColor,
                      mini: true,
                      child: Icon(_editCover ? iconsEdit[index] : icons[index],
                        ...
                        if (_editCover) {
                          if (iconsEditTooltip[index] == 'Cancel') {
                            ...
                            setState(() {
                              ...
                              _title[0]['subtitle_kiri'] =
                                  _controllerCoverSubtitleKiri.text;
                              _title[0]['subtitle_kanan'] =
                                  _controllerCoverSubtitleKanan.text;
                              _editCover = !_editCover;
                            });
                          }
                        } else {
