...
class _FormDetailState extends State<FormDetail> with TickerProviderStateMixin {
  ...
  List<Map> _title = [
    ...
    {'title': '1. TUJUAN', 'title_dalam' : ' ', 'isi': 'a. Memastikan agar material dan produk diperiksa\n\nb. Menjamin spesifikasi produk yang diproses sesuai dengan standar perusahaan'},
    {'title': '2. RUANG LINGKUP', 'title_dalam':' ', 'isi': 'Prosedur ini berlaku untuk seluruh material dari proses incoming / inproses / outgoing proses'},
    {'title': '3. REFERENSI', 'title_dalam':' ', 'isi': 'ISO 9001 : 2015'},
    {'title': '4. ISTILAH', 'title_dalam':' ', 'isi': 'ISO : Sistem manajemen untuk meningkatkan mutu'},
    {'title': '5. CATATAN REVISI', 'title_dalam':' ', 'isi': 'Pengukuran suhu secara manual diganti dengan thermometer otomatis', 'revisi': 'REV 01', 'tgl_revisi': '17 January 2018', 'bab': 'Bab 6', 'oleh': 'Ridwan Kamil'},
    {'title': '6. RISIKO', 'title_dalam':' ', 'isi': 'Kegagalan dalam penerapan procedure ini dapat menyebabkan.\n\na. Risiko terjadinya ketidaksesuaian spesifikasi produk\n\nb. Penurunan kualitas produk yang akan ataupun yang sudah diproduksi'},
    {'title': '7. PROSEDUR', 'title_dalam':' ', 'isi': 'Melakukan pemeriksaan kualitas sesuai spesifikasi produk'},
    {'title': '7. PROSEDUR', 'title_dalam':' ', 'isi': 'Apakah produk sesuai spesifikasi'},
    {'title': '7. PROSEDUR', 'title_dalam':' ', 'isi': '1. Menerima produk\n\n2. Menandatangani dokumen'},
    {'title': '7. PROSEDUR', 'title_dalam':' ', 'isi': 'Menyortir produk yang tidak sesuai spesifikasi'},
    {'title': '7. PROSEDUR', 'title_dalam':' ', 'isi': 'Mencatat produk yang tidak sesuai spesifikasi'},
    {'title': '7. PROSEDUR', 'title_dalam':' ', 'isi': 'Info produk yang disortir kepada supplier'},
    {'title': '7. PROSEDUR', 'title_dalam':' ', 'isi': 'Mengembalikan produk yang disortir kepada kurir'},
    {'title': '7. PROSEDUR', 'title_dalam':' ', 'isi': 'Mengembalikan produk yang disortir kepada kurir'},
    {'title': '7. PROSEDUR', 'title_dalam':' ', 'isi': '1. Menerima produk\n\n2. Menandatangani dokumen'},
  ];
  ...
  TextEditingController _controllerCoverSubtitleKiri = TextEditingController();
  TextEditingController _controllerCoverSubtitleKanan = TextEditingController();
  ...
  void initState() {
    ...
    _controllerCoverSubtitleKiri.text = _title[0]['subtitle_kiri'];
    _controllerCoverSubtitleKanan.text = _title[0]['subtitle_kanan'];
                    ...
                    if (_editCover) {
                      if (iconsEditTooltip[index] == 'Cancel') {
                        ...
                        setState(() {
                          ...
                          _title[0]['subtitle_kiri'] = _controllerCoverSubtitleKiri.text;
                          _title[0]['subtitle_kanan'] = _controllerCoverSubtitleKanan.text;
            ...
            FloatingActionButton(
              ...
              child: AnimatedBuilder(
                ...
                builder: (BuildContext context, Widget child) {
                  return Transform(
                    transform: Matrix4.rotationZ(_controller2.value * 0.5 * math.pi),
                    alignment: FractionalOffset.center,
                    child: _controller2.isDismissed ? Text('REVISI', style: TextStyle(fontSize: 12.0)) : Icon(Icons.close),
                  );
                },
              ),
              onPressed: () {
