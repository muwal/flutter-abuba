                                  ...
                                  child: RaisedButton(
                                    ...
                                    onPressed: () {
                                      if (animationController.isAnimating) {
                                        ...
                                        Navigator.push(context,
                                          MyCustomRoute(
                                            builder: (context) => FormFinishing(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: widget.finalBantu, aksesStatus: widget.aksesStatus)
                                          )
                                        );
                                      }
                                    },
                                                    ...
                                                    if (scoreThanking[indexThanking] == null) {
                                                      ...
                                                      if (indexThanking + 1 < jumlahThanking) {
                                                        ...
                                                        docReference.updateData({
                                                          ...
                                                          double finalBantu = widget.finalBantu + finalThanking + finalBilling;
                                                          Navigator.push(context,
                                                            MaterialPageRoute(
                                                              builder: (_) => FormSedikitLagi(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: finalBantu, aksesStatus: widget.aksesStatus)
                                                            )
                                                          );
                                                        }).catchError((error) {
                                                          print(error);
...
class _FormSedikitLagiState extends State<FormSedikitLagi> with TickerProviderStateMixin {
  AnimationController animationController;
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            Flexible(
                              child: Text(
                                'Perhatikan suasana outlet, toilet, mushola, dan tempat parkir',
                                style: TextStyle(
                                    fontSize: 14.0, color: Colors.black54),
                                textAlign: TextAlign.center,
                              ),
                                                    ...
                                                    if (scoreParking[indexParking] == null) {
                                                      ...
                                                      if (indexParking + 1 < jumlahParking) {
                                                        ...
                                                        docReference.updateData({
                                                          ...
                                                          double finalBantu = widget.finalBantu + finalParking + finalCleanliness + finalPreBushing;
