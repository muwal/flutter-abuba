                                    ...
                                    child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        if (animationController.isAnimating) {
                                          ...
                                          Firestore.instance.collection('mystery_shopper').document(widget.index).snapshots().listen((data) {
                                            if (data.exists) {
                                              if (data.data.containsKey('actTime')) {
                                                if (data.data['actTime'].contains(null)) {
                                                  ...
                                                  Navigator.pushReplacement(context,
                                                    MaterialPageRoute(
                                                      builder: (context) => FormEnjoy(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalServingTime: data.data['hasilServingTime'], aksesStatus: widget.aksesStatus)
                                                    )
                                                  );
                                                }
                                              } else {
                                    ...
                                    child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        if (animationController.isAnimating) {
                                          ...
                                          Firestore.instance.collection('mystery_shopper').document(widget.index).snapshots().listen((data) {
                                            if (data.exists) {
                                              if (data.data.containsKey('lastReview') == false) {
                                                Navigator.pushReplacement(context,
                                                  MyCustomRoute(
                                                    builder: (context) => FormReviewGreeting(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalServingTime: data.data['hasilServingTime'], aksesStatus: widget.aksesStatus)
                                                  )
                                                );
                                              } else {
                                                if (data.data['lastReview'] == 'greeting') {
                                                  Navigator.pushReplacement(context,
                                                    MyCustomRoute(
                                                      builder: (context) => FormReviewSeating(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: data.data['tempScore'], aksesStatus: widget.aksesStatus),
                                                    )
                                                  );
                                                } else if (data.data['lastReview'] == 'seating') {
                                                  Navigator.pushReplacement(context,
                                                    MyCustomRoute(
                                                      builder: (context) => FormReviewTakingOrder(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: data.data['tempScore'], aksesStatus: widget.aksesStatus)
                                                    )
                                                  );
                                                } else if (data.data['lastReview'] == 'takingOrder') {
                                                  Navigator.pushReplacement(context,
                                                    MyCustomRoute(
                                                      builder: (context) => FormReviewServingProduct(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: data.data['tempScore'], aksesStatus: widget.aksesStatus)
                                                    )
                                                  );
                                                } else if (data.data['lastReview'] == 'servingProduct') {
                                                  Navigator.pushReplacement(context,
                                                    MyCustomRoute(
                                                      builder: (context) => FormMockComplaint(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: data.data['tempScore'], aksesStatus: widget.aksesStatus)
                                                    )
                                                  );
                                                } else if (data.data['lastReview'] == 'complaint1') {
                                                  Navigator.pushReplacement(context,
                                                    MyCustomRoute(
                                                      builder: (context) => FormHandling(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: data.data['tempScore'], complaintCategory: data.data['tempCategory'], aksesStatus: widget.aksesStatus)
                                                    )
                                                  );
                                                } else if (data.data['lastReview'] == 'complaint2') {
                                                  Navigator.pushReplacement(context,
                                                    MyCustomRoute(
                                                      builder: (context) => FormPreBushing(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: data.data['tempScore'], aksesStatus: widget.aksesStatus)
                                                    )
                                                  );
                                                } else if (data.data['lastReview'] == 'preBushing') {
                                                  Navigator.pushReplacement(context,
                                                    MyCustomRoute(
                                                      builder: (context) => FormCleanliness(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: data.data['tempScore'], aksesStatus: widget.aksesStatus)
                                                    )
                                                  );
                                                } else if (data.data['lastReview'] == 'cleanliness') {
                                                  Navigator.pushReplacement(context,
                                                    MyCustomRoute(
                                                      builder: (context) => FormReviewBilling(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: data.data['tempScore'], aksesStatus: widget.aksesStatus)
                                                    )
                                                  );
                                                } else if (data.data['lastReview'] == 'billing') {
                                                  Navigator.pushReplacement(context,
                                                    MyCustomRoute(
                                                      builder: (context) => FormReviewThanking(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: data.data['tempScore'], aksesStatus: widget.aksesStatus)
                                                    )
                                                  );
                                                } else if (data.data['lastReview'] == 'thanking') {
                                                  Navigator.pushReplacement(context,
                                                    MyCustomRoute(
                                                      builder: (context) => FormReviewParking(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: data.data['tempScore'], aksesStatus: widget.aksesStatus)
                                                    )
                                                  );
                                                } else if (data.data['lastReview'] == 'parking') {
                                                  Navigator.pushReplacement(context,
                                                    MaterialPageRoute(
                                                      builder: (_) => FormCheckOut(index: widget.index, idUser: widget.idUser, finalBantu: data.data['tempHasilGrafik'], imageOutlet: widget.imageOutlet, aksesStatus: widget.aksesStatus),
                                                    )
                                                  );
                                                } else {
                                                  Navigator.pushReplacement(context,
                                              ...
                                              Navigator.pushReplacement(context,
                                                MyCustomRoute(
                                                  builder: (context) => FormReviewGreeting(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalServingTime: widget.finalServingTime, aksesStatus: widget.aksesStatus)
                                                )
                                              );
                                            }
                                          });
...
class FormReviewGreeting extends StatefulWidget {
  final double finalServingTime;
  final String outlet;
  final int idOutlet;
  final String imageOutlet;
  ...
  @override
  _FormReviewGreetingState createState() => _FormReviewGreetingState();
}

class _FormReviewGreetingState extends State<FormReviewGreeting> with TickerProviderStateMixin {
  List<Map> _listData = [{'nomor': '1'}];
                                                        ...
                                                        onPressed: () {
                                                          setState(() {
                                                            if (scoreGreeting[indexGreeting] == null) {
                                                              ...
                                                              print('sudah terjawab');
                                                              if (indexGreeting + 1 < jumlahGreeting) {
                                                                print('next pertanyaan greeting');
                                                                indexGreeting++;
                                                              } else {
                                                                print('save greeting');
                                                                print(bobotGreeting[0]);
                                                                print(scoreGreeting);
                                                                print(widget.finalServingTime);
                                                                ...
                                                                finalGreeting = (hasilGreeting * bobotBantuGreeting) + double.tryParse(widget.finalServingTime.toString());
                                                                ...
                                                                docReference.updateData({
                                                                  ...
                                                                  'hasilGreeting': hasilGreeting,
                                                                  'lastReview': 'greeting',
                                                                  'tempScore': finalGreeting
                                                                }).then((doc) {
                                                                  print(hasilGreeting);
                                                                  print(bobotBantuGreeting);
                                                                  print(widget.finalServingTime);
                                                                  Navigator.pushReplacement(context,
                                                                    MaterialPageRoute(
                                                                      builder: (_) => FormReviewSeating(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: finalGreeting, aksesStatus: widget.aksesStatus)
                                                                    )
                                                                  );
...
// batas greeting
class FormReviewSeating extends StatefulWidget {
  ...
  @override
  _FormReviewSeatingState createState() => _FormReviewSeatingState();
}

class _FormReviewSeatingState extends State<FormReviewSeating> with TickerProviderStateMixin {
  List<Map> _listData = [
    {'nomor': '1'},
  ];
                                                          ...
                                                          setState(() {
                                                            if (scoreSeating[indexSeating] == null) {
                                                              ...
                                                              if (indexSeating + 1 < jumlahSeating) {
                                                                ...
                                                                finalSeating = (hasilSeating * bobotBantuSeating) + widget.finalBantu;
                                                                ...
                                                                docReference.updateData({
                                                                  ...
                                                                  'hasilSeating': hasilSeating,
                                                                  'lastReview': 'seating',
                                                                  'tempScore': finalSeating
                                                                }).then((doc) {
                                                                  // taro sini seating
                                                                  print(hasilSeating);
                                                                  print(bobotBantuSeating);
                                                                  print(widget.finalBantu);

                                                                  Navigator.pushReplacement(context,
                                                                    MaterialPageRoute(
                                                                      builder: (_) => FormReviewTakingOrder(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: finalSeating, aksesStatus: widget.aksesStatus)
                                                                    )
                                                                  );
                                                                }).catchError((error) {
                                                                  print(error);
...
class FormReviewTakingOrder extends StatefulWidget {
  final double finalBantu;
  final String outlet;
  final int idOutlet;
  final String imageOutlet;
  ...
  var index;
  final String aksesStatus;
  FormReviewTakingOrder(
      {this.outlet, this.imageOutlet, this.alamatOutlet, this.idOutlet, this.idUser, this.idMysteryGuest, this.index, this.finalBantu, this.aksesStatus});

  @override
  _FormReviewTakingOrderState createState() => _FormReviewTakingOrderState();
}

class _FormReviewTakingOrderState extends State<FormReviewTakingOrder> with TickerProviderStateMixin {
  List<Map> _listData = [
    {'nomor': '1'},
  ];
                                                          ...
                                                          setState(() {
                                                            if (scoreTakingOrder[indexTakingOrder] == null) {
                                                              ...
                                                              if (indexTakingOrder + 1 < jumlahTakingOrder) {
                                                                ...
                                                                finalTakingOrder = (hasilTakingOrder * bobotBantuTakingOrder) + widget.finalBantu;
                                                                ...
                                                                docReference.updateData({
                                                                  ...
                                                                  'hasilTakingOrder': hasilTakingOrder,
                                                                  'lastReview': 'takingOrder',
                                                                  'tempScore': finalTakingOrder
                                                                }).then((doc) {
                                                                  // taro sini taking order
                                                                  // _cardController.animateTo(_cardController.index + 1);

                                                                  Navigator.pushReplacement(context,
                                                                    MaterialPageRoute(
                                                                      builder: (_) => FormReviewServingProduct(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: finalTakingOrder, aksesStatus: widget.aksesStatus)
                                                                    )
                                                                  );
                                                                }).catchError((error) {
                                                                  print(error);
...
class FormReviewServingProduct extends StatefulWidget {
  final double finalBantu;
  final String outlet;
  final int idOutlet;
  final String imageOutlet;
  ...
  var index;
  final String aksesStatus;
  FormReviewServingProduct(
      {this.outlet, this.imageOutlet, this.alamatOutlet, this.idOutlet, this.idUser, this.idMysteryGuest, this.index, this.finalBantu, this.aksesStatus});

  @override
  _FormReviewServingProductState createState() => _FormReviewServingProductState();
}

class _FormReviewServingProductState extends State<FormReviewServingProduct> with TickerProviderStateMixin {
  List<Map> _listData = [
    {'nomor': '1'},
  ];
                                                          ...
                                                          setState(() {
                                                            if (scoreServingProduct[indexServingProduct] == null) {
                                                              ...
                                                              if (indexServingProduct + 1 < jumlahServingProduct) {
                                                                ...
                                                                double finalBantu = widget.finalBantu + finalServingProduct;
                                                                ...
                                                                docReference.updateData({
                                                                  ...
                                                                  'hasilServingProduct': hasilServingProduct,
                                                                  'lastReview': 'servingProduct',
                                                                  'tempScore': finalBantu
                                                                }).then((doc) {
                                                                  Navigator.pushReplacement(context,
                                                                    MaterialPageRoute(
                                ...
                                onPressed: () {
                                  if (_formKey.currentState.validate() && showError == false) {
                                    ...
                                    docReference.updateData({
                                      ...
                                      'lastReview': 'complaint1',
                                      'tempCategory': _myCategory
                                    }).then((doc) {
                                      Navigator.pushReplacement(context,
                                        MyCustomRoute(
                                  ...
                                  child: RaisedButton(
                                    ...
                                    onPressed: () {
                                      if (animationController.isAnimating) {
                                        ...
                                        Navigator.pushReplacement(context,
                                          MyCustomRoute(
                                            builder: (context) => FormReviewBilling(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: widget.finalBantu, aksesStatus: widget.aksesStatus)
                                          )
                                        );
                                      }
                                    },
...
class FormReviewBilling extends StatefulWidget {
  final double finalBantu;
  final String outlet;
  final int idOutlet;
  final String imageOutlet;
  ...
  @override
  _FormReviewBillingState createState() => _FormReviewBillingState();
}

class _FormReviewBillingState extends State<FormReviewBilling> with TickerProviderStateMixin {
  List<Map> _listData = [
    {'nomor': '11'},
  ];
                                                  ...
                                                  setState(() {
                                                    if (scoreBilling[indexBilling] == null) {
                                                      ...
                                                      if (indexBilling + 1 < jumlahBilling) {
                                                        ...
                                                        finalBilling = (hasilBilling * bobotBantuBilling) + widget.finalBantu;
                                                        ...
                                                        docReference.updateData({
                                                          ...
                                                          Navigator.pushReplacement(context,
                                                            MyCustomRoute(
                                                              builder: (context) => FormReviewThanking(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: finalBilling, aksesStatus: widget.aksesStatus)
                                                            )
                                                          );
                                                        }).catchError((error) {
                                                          print(error);
...
class FormReviewThanking extends StatefulWidget {
  final double finalBantu;
  final String outlet;
  final int idOutlet;
  final String imageOutlet;
  ...
  @override
  _FormReviewThankingState createState() => _FormReviewThankingState();
}

class _FormReviewThankingState extends State<FormReviewThanking> with TickerProviderStateMixin {
  List<Map> _listData = [
    {'nomor': '11'},
  ];
                                                  ...
                                                  setState(() {
                                                    if (scoreThanking[indexThanking] == null) {
                                                      ...
                                                      if (indexThanking + 1 < jumlahThanking) {
                                                        ...
                                                        finalThanking = (hasilThanking * bobotBantuThanking) + widget.finalBantu;
                                                        ...
                                                        docReference.updateData({
                                                          ...
                                                          Navigator.pushReplacement(context,
                                                            MyCustomRoute(
                                                              builder: (context) => FormReviewParking(idOutlet: widget.idOutlet,alamatOutlet: widget.alamatOutlet,outlet: widget.outlet,imageOutlet: widget.imageOutlet,idUser: widget.idUser, idMysteryGuest: widget.idMysteryGuest, index: widget.index, finalBantu: finalThanking, aksesStatus: widget.aksesStatus)
                                                            )
                                                          );
                                                        }).catchError((error) {
                                                          print(error);
...
class FormReviewParking extends StatefulWidget {
  final double finalBantu;
  final String outlet;
  final int idOutlet;
  final String imageOutlet;
  ...
  @override
  _FormReviewParkingState createState() => _FormReviewParkingState();
}

class _FormReviewParkingState extends State<FormReviewParking> with TickerProviderStateMixin {
  List<Map> _listData = [
    {'nomor': '11'}
  ];
                                                  ...
                                                  setState(() {
                                                    if (scoreParking[indexParking] == null) {
                                                      ...
                                                      if (indexParking + 1 < jumlahParking) {
                                                        ...
                                                        double finalBantu = widget.finalBantu + finalParking;
