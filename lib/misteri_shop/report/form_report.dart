                ...
                builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                  ...
                  return Column(
                    children: List.generate(snapshot.data.documents.length, (index) {
                      DateTime tanggalBantu = DateTime.tryParse(snapshot.data.documents[index].data['checkIn'].toString());
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    Flexible(
                                      child: Text(
                                        buttonView[index] ? 'Preparing ...' : snapshot.data.documents[index].data['checkIn'].toString().substring(8, 10) + '/' + snapshot.data.documents[index].data['checkIn'].toString().substring(5, 7) + '/' + snapshot.data.documents[index].data['checkIn'].toString().substring(0, 4),
                                        style: TextStyle(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    Flexible(
                                      child: Text(
                                        buttonView[index] ? 'Preparing data ...' : snapshot.data.documents[index].data['checkIn'].toString().substring(8, 10) + '/' + snapshot.data.documents[index].data['checkIn'].toString().substring(5, 7) + '/' + snapshot.data.documents[index].data['checkIn'].toString().substring(0, 4),
                                        style: TextStyle(
                                            fontSize: 13.0, color: buttonView[index] ? Colors.black54 : Colors.blue),
                                        textAlign: TextAlign.right,
                                      ),
