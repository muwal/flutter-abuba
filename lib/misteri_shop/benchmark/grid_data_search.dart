                              ...
                              setState(() {
                                if (selectedOutlet.length < 2) {
                                  if (selectedOutletID.contains(snapshot.data.documents[index].documentID)) {
                                    ...
                                    selectedOutletTanggal.add(snapshot.data.documents[index].data['checkIn'].toString().substring(8, 10) + '/' + snapshot.data.documents[index].data['checkIn'].toString().substring(5, 7) + '/' + snapshot.data.documents[index].data['checkIn'].toString().substring(0, 4));
                                  }
                                } else {
                                  if (selectedOutletID.contains(snapshot.data.documents[index].documentID)) {
                                    selectedOutlet.removeWhere((item) => item == snapshot.data.documents[index].data['outlet']);
                            ...
                            trailing: Container(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  Flexible(
                                    child: Text(
                                      snapshot.data.documents[index].data['checkIn'].toString().substring(8, 10) + '/' + snapshot.data.documents[index].data['checkIn'].toString().substring(5, 7) + '/' + snapshot.data.documents[index].data['checkIn'].toString().substring(0, 4),
                                      style: TextStyle(
