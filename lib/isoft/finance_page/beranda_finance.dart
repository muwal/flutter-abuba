...
class BerandaFinance extends StatefulWidget {
  ...
  BerandaFinance({this.idUser, this.namaUser, this.departmentUser});
  @override
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        Navigator.push(context,
                            MyCustomRoute(builder: (context) => BerandaPurchasing(idUser: widget.idUser, departmentUser: widget.departmentUser, namaUser: widget.namaUser)));
                      },
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: <Widget>[
