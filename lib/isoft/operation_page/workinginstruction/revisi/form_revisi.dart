...
import 'package:flutter_abuba/isoft/operation_page/workinginstruction/approve/detail_approve.dart';
import 'package:flutter_abuba/isoft/operation_page/workinginstruction/revisi/detail_revisi.dart';
// import 'detail_review.dart';

class FormRevisiWorking extends StatefulWidget {
  final int idUser;
  final String namaUser;
  final String departmentUser;
  FormRevisiWorking({this.idUser, this.namaUser, this.departmentUser});

  @override
  _FormRevisiWorkingState createState() => _FormRevisiWorkingState();
}

class _FormRevisiWorkingState extends State<FormRevisiWorking> with TickerProviderStateMixin {
  ...
  List<String> bantuinstruksiList= [];
    ...
    reference.where('createdBy', isEqualTo: widget.idUser).where('status', isEqualTo: 'REJECTED').snapshots().listen((querySnapshot) {
      querySnapshot.documentChanges.forEach((change) {
        setState(() {
          ...
          createdBy.add(change.document.data['createdBy']);
          ...
          bantuinstruksi.add(change.document.data.containsKey('istilahComment') ? 'YES' : 'NO');
    ...
    return new Flexible(
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            if (createdBy[index] == widget.idUser) {
  ...
  Widget _searchListView() {
    ...
    bantuinstruksiList= List<String> ();
    ...
    for (int i = 0; i < dateCreated.length; i++) {
      ...
      var bantuinstruksiDua= bantuinstruksi[i];
      ...
      if (judulDua.toLowerCase().contains(_searchText.toLowerCase())) {
        ...
        createdByList.add(createdByDua);
        ...
        bantuinstruksiList.add(bantuinstruksiDua);
    ...
    return new Flexible(
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            if (createdByList[index] == widget.idUser) {
              if (statusList[index] == 'REJECTED') {
                return Container(
                  width: width,
                  color: Colors.white,
                  child: Column(
                                      ...
                                      ButtonTheme(
                                        ...
                                        child: OutlineButton(
                                            ...
                                            onPressed: () {
                                              Navigator.push(context,
                                                  MyCustomRoute(
                                                      builder: (context) => new FormDetailRevisiWorking(idUser: widget.idUser, namaUser: widget.namaUser, departmentUser: widget.departmentUser, index: docIDList[index], pJabatan: pJabatanList[index], pDocTerkait: pDocTerkaitList[index], pDepartment: pDepartmentList[index], pComment: pCommentList[index], pCommentStatus: pCommentStatusList[index], tujuanCommentCreated: tujuanCommentCreatedList[index], ruangLingkupCommentCreated: ruangLingkupCommentCreatedList[index], referensiCommentCreated: referensiCommentCreatedList[index], istilahCommentCreated: istilahCommentCreatedList[index], prosedurCommentTgl: prosedurCommentTglList[index], risikoCommentCreated: risikoCommentCreatedList[index], bantureferensi: bantureferensiList[index], banturisiko: banturisikoList[index], banturuanglingkup: banturuanglingkupList[index], bantutujuan: bantutujuanList[index])
                                                  )
                                              );
                                            }
                                        ),
