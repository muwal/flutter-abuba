...
class FormReviewWorking extends StatefulWidget {
  final int idUser;
  final String namaUser;
  final String departmentUser;
  FormReviewWorking({this.idUser, this.namaUser, this.departmentUser});

  @override
  _FormReviewWorkingState createState() => _FormReviewWorkingState();
}

class _FormReviewWorkingState extends State<FormReviewWorking> with TickerProviderStateMixin {
                                        ...
                                        child: OutlineButton(
                                            ...
                                            onPressed: () {
                                              Navigator.push(context,
                                                  MyCustomRoute(
                                                      builder: (context) => new FormDetailWorking(idUser: widget.idUser, namaUser: widget.namaUser, departmentUser: widget.departmentUser, index: docID[index], pJabatan: pJabatan[index], pDocTerkait: pDocTerkait[index], pDepartment: pDepartment[index], pComment: pComment[index], pCommentStatus: pCommentStatus[index], tujuanCommentCreated: tujuanCommentCreated[index], ruangLingkupCommentCreated: ruangLingkupCommentCreated[index], referensiCommentCreated: referensiCommentCreated[index], istilahCommentCreated: istilahCommentCreated[index], prosedurCommentTgl: prosedurCommentTgl[index], risikoCommentCreated: risikoCommentCreated[index], bantuinstruksi: bantuinstruksi[index], bantureferensi: bantureferensi[index], banturisiko: banturisiko[index], banturuanglingkup: banturuanglingkup[index], bantutujuan: bantutujuan[index])
                                                  )
                                              );
                                            }
                                        ),
                                      ...
                                      ButtonTheme(
                                        ...
                                        child: OutlineButton(
                                            ...
                                            onPressed: () {
                                              Navigator.push(context,
                                                  MyCustomRoute(
                                                      builder: (context) => new FormDetailWorking(idUser: widget.idUser, namaUser: widget.namaUser, departmentUser: widget.departmentUser, index: docIDList[index], pJabatan: pJabatanList[index], pDocTerkait: pDocTerkaitList[index], pDepartment: pDepartmentList[index], pComment: pCommentList[index], pCommentStatus: pCommentStatusList[index], tujuanCommentCreated: tujuanCommentCreatedList[index], ruangLingkupCommentCreated: ruangLingkupCommentCreatedList[index], referensiCommentCreated: referensiCommentCreatedList[index], istilahCommentCreated: istilahCommentCreatedList[index], prosedurCommentTgl: prosedurCommentTglList[index], risikoCommentCreated: risikoCommentCreatedList[index], bantuinstruksi: bantuinstruksiList[index], bantureferensi: bantureferensiList[index], banturisiko: banturisikoList[index], banturuanglingkup: banturuanglingkupList[index], bantutujuan: bantutujuanList[index])
                                                  )
                                              );
                                            }
                                        ),
