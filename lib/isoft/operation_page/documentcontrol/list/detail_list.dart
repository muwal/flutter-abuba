...
class FormDetail extends StatefulWidget {
  ...
  String type;
  String from;
  FormDetail({this.idUser, this.namaUser, this.departmentUser, this.index, this.pJabatan, this.pDocTerkait, this.pComment, this.pCommentStatus, this.pDepartment, this.tujuanCommentCreated, this.istilahCommentCreated, this.referensiCommentCreated, this.ruangLingkupCommentCreated, this.prosedurCommentTgl, this.bantutujuan, this.bantureferensi, this.banturuanglingkup, this.bantuistilah, this.banturisiko, this.risikoCommentCreated, this.type, this.from});
