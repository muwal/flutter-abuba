...
class FormList extends StatefulWidget {
  ...
  FormList({this.idUser, this.namaUser, this.departmentUser});

  @override
  _FormListState createState() => _FormListState();
}

class _FormListState extends State<FormList> with TickerProviderStateMixin {
  ...
  //     MaterialPageRoute(
  //       builder: (_) => FormApprove(idUser: widget.idUser, departmentUser: widget.departmentUser, namaUser: widget.namaUser),
  //     )
  //   );
  //   return null;
  // }
      ...
      child: Scaffold(
        ...
        body: RefreshIndicator(
          ...
          onRefresh: () {
            Navigator.pushReplacement(context, 
              MaterialPageRoute(
                builder: (_) => FormList(idUser: widget.idUser, departmentUser: widget.departmentUser, namaUser: widget.namaUser),
              )
            );
          },
                                      ...
                                      child: OutlineButton(
                                          ...
                                          onPressed: () {
                                            Navigator.push(context,
                                                MyCustomRoute(
                                                    builder: (context) => new FormDetail(idUser: widget.idUser, namaUser: widget.namaUser, departmentUser: widget.departmentUser, index: docID[index], pJabatan: typeDoc[index] == 'video' ? [] : pJabatan[index], pDocTerkait: typeDoc[index] == 'video' ? [] : pDocTerkait[index], pDepartment: typeDoc[index] == 'video' ? [] : pDepartment[index], pComment: typeDoc[index] == 'video' ? [] : pComment[index], pCommentStatus: typeDoc[index] == 'video' ? [] : pCommentStatus[index], tujuanCommentCreated: tujuanCommentCreated[index], ruangLingkupCommentCreated: ruangLingkupCommentCreated[index], referensiCommentCreated: referensiCommentCreated[index], istilahCommentCreated: istilahCommentCreated[index], prosedurCommentTgl: prosedurCommentTgl[index], risikoCommentCreated: risikoCommentCreated[index], bantuistilah: bantuistilah[index], bantureferensi: bantureferensi[index], banturisiko: banturisiko[index], banturuanglingkup: banturuanglingkup[index], bantutujuan: bantutujuan[index], type: typeDoc[index], from: 'list')
                                                )
                                            );
                                          }
                                      ),
