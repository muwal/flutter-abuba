...
import 'detail_approve.dart';

class FormApprove extends StatefulWidget {
  final int idUser;
  final String namaUser;
  final String departmentUser;
  FormApprove({this.idUser, this.namaUser, this.departmentUser});

  @override
  _FormApproveState createState() => _FormApproveState();
}

class _FormApproveState extends State<FormApprove> with TickerProviderStateMixin {
    ...
    reference.where('approvedBy', isEqualTo: widget.idUser).where('status', isEqualTo: 'REVIEWED').snapshots().listen((querySnapshot) {
      querySnapshot.documentChanges.forEach((change) {
        setState(() {
          ...
          approvedBy.add(change.document.data['approvedBy']);
    ...
    return new Flexible(
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            if (approvedBy[index] == widget.idUser) {
  ...
  Widget _searchListView() {
    ...
    for (int i = 0; i < dateCreated.length; i++) {
      ...
      var approvedByDua= approvedBy[i];
      ...
      if (judulDua.toLowerCase().contains(_searchText.toLowerCase())) {
        ...
        approvedByList.add(approvedByDua);
    ...
    return new Flexible(
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            if (approvedByList[index] == widget.idUser) {
