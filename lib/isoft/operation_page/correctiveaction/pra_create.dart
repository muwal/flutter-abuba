...
class PraReport extends StatefulWidget {
  final int idUser;
  final String namaUser;
  final String departmentUser;
  PraReport({this.idUser, this.namaUser, this.departmentUser});

  @override
  _PraReportState createState() => _PraReportState();
}

class _PraReportState extends State<PraReport> with TickerProviderStateMixin {
