...
class DetailReportInventory extends StatefulWidget {
  DetailReportInventory({this.idUser, this.namaUser, this.departmentUser, this.index});
  ...
  @override
  _DetailReportInventoryState createState() => _DetailReportInventoryState();
}

class _DetailReportInventoryState extends State<DetailReportInventory> with TickerProviderStateMixin {
