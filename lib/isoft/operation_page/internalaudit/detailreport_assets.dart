...
class DetailReportAssets extends StatefulWidget {
  DetailReportAssets({this.idUser, this.namaUser, this.departmentUser, this.index});
  ...
  @override
  _DetailReportAssetsState createState() => _DetailReportAssetsState();
}

class _DetailReportAssetsState extends State<DetailReportAssets> with TickerProviderStateMixin {
