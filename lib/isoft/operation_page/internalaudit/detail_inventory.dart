...
class DetailInventory extends StatefulWidget {
  DetailInventory({this.idUser, this.namaUser, this.departmentUser, this.index});
...
class _DetailInventoryState extends State<DetailInventory> with TickerProviderStateMixin {
  ...
  TextEditingController controllerPersediaan = TextEditingController();
  ...
  double perhitunganSaldoAkhir = 0;
  double perhitunganSelisih = 0;
  
  List<String> persediaanArray = [];
  List<double> saldoAwalArray = [];
  List<double> penambahanArray = [];
  List<double> penguranganArray = [];
  List<double> saldoAkhirArray = [];
  List<double> saldoFisikArray = [];
  List<double> selisihArray = [];
  List<String> arrayKualitas = [];

  String status;
  List<dynamic> persediaanArray2 = [];
  ...
  void initState() {
    ...
    Firestore.instance.collection('audit_internalDetail-inventory').where('docRef', isEqualTo: widget.index).snapshots().listen((data2) {
      setState(() {
        if (data2.documents.length == 0) {
          status = 'open';
        } else {
          persediaanArray2 = data2.documents[data2.documents.length - 1].data['persediaan'];
                          ...
                          builder: (context) {
                            return ButtonTheme(
                              ...
                              child: RaisedButton(
                                ...
                                onPressed: () {
                                  if (persediaanArray.length == 0 ||saldoAwalArray.length == 0 ||penambahanArray.length == 0 ||penguranganArray.length == 0 ||saldoAkhirArray.length == 0 ||saldoFisikArray.length == 0 ||selisihArray.length == 0 || arrayKualitas.length == 0) {
                                    ...
                                    if (_isProccess == false) {
                                      ...
                                      DocumentReference docReference = Firestore.instance.collection('audit_internalDetail-inventory').document();

                                      docReference.setData({
                                        'docRef': widget.index,
                                        'persediaan': persediaanArray,
                                  ...
                                  child: Container(
                                    ...
                                    child:  Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: <Widget>[
                                          Flexible(child: Text('1. Persediaan', style: TextStyle(fontSize: 16.0, color: Colors.black38),),),
                                          Flexible(
                                            child: Container(
                                              height: 35.0,
                                              child: TextField(
                                                ...
                                                controller: controllerPersediaan,
                                          ...
                                          Flexible(
                                            child: Container(
                                              ...
                                              child: TextField(
                                                ...
                                                onChanged: (val) {
                                                  setState(() {
                                                    perhitunganSaldoAkhir = double.tryParse(saldoAwal.text.toString())+double.tryParse(penambahan.text.toString()) - double.tryParse(pengurangan.text.toString());
                                                    perhitunganSelisih = perhitunganSaldoAkhir - double.tryParse(saldoFisik.text.toString());
                                    ...
                                    Padding(
                                      ...
                                      child: ButtonTheme(
                                        ...
                                        child: OutlineButton(
                                          ...
                                          onPressed: () {
                                            setState(() {
                                              persediaanArray.add(controllerPersediaan.text);
                                              saldoAwalArray.add(double.tryParse(saldoAwal.text.toString()));
                                              penambahanArray.add(double.tryParse(penambahan.text.toString()));
                                              penguranganArray.add(double.tryParse(pengurangan.text.toString()));
                                              saldoAkhirArray.add(double.tryParse(saldoAkhir.text.toString()));
                                              saldoFisikArray.add(double.tryParse(saldoFisik.text.toString()));
                                              selisihArray.add(double.tryParse(selisih.text.toString()));
                                              arrayKualitas.add(value1 == 1 ? 'BAIK' : 'TIDAK');

                                              controllerPersediaan.clear();
                                              saldoAwal.clear();
                                              penambahan.clear();
                                              pengurangan.clear();
                                              saldoAkhir.clear();
                                ...
                                children: <Widget>[
                                  ...
                                  Flexible(
                                    child: ListView.builder(
                                      itemCount: persediaanArray.length,
                                            ...
                                            children: <Widget>[
                                              ...
                                              Container(
                                                ...
                                                child: IconButton(
                                                  ...
                                                  onPressed: () {
                                                    setState(() {
                                                      persediaanArray.removeAt(index);
                                              ...
                                              child: Container(
                                                ...
                                                child:  Padding(
                                                  ...
                                                  child: Row(
                                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                    children: <Widget>[
                                                      Flexible(child: Text('1. Persediaan', style: TextStyle(fontSize: 16.0, color: Colors.black38, fontWeight: FontWeight.w700),),),
                                                      Flexible(child: Text(persediaanArray[index], style: TextStyle(fontSize: 16.0, color: Colors.black, fontWeight: FontWeight.w700),),),
                                                    ],
                                                  ),
                                                ),
                                              ),
            ...
            child: AnimatedBuilder(
              ...
              builder: (_, Widget child) {
                return animationController.isAnimating
                  ...
                  : ListView.builder(
                      itemCount: persediaanArray2.length,
                      itemBuilder: (BuildContext context, int index) {
                        return ExpansionTile(
                          title: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: <Widget>[
                              Container(
                                ...
                                child: Text(
                                  '${index + 1}. ${persediaanArray2[index]}',
                                  style: TextStyle(
                                    fontWeight: FontWeight.w700
                                  ),
                                ),
                              ...
                              child: Container(
                                ...
                                child:  Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      Flexible(child: Text('1. Persediaan', style: TextStyle(fontSize: 16.0, color: Colors.black38, fontWeight: FontWeight.w700),),),
                                      Flexible(child: Text(persediaanArray2[index], style: TextStyle(fontSize: 16.0, color: Colors.black, fontWeight: FontWeight.w700),),),
                                    ],
                                  ),
                                ),
                              ),
