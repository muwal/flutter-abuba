...
class DetailEquipment extends StatefulWidget {
  DetailEquipment({this.idUser, this.namaUser, this.departmentUser, this.index});
  ...
  @override
  _DetailEquipmentState createState() => _DetailEquipmentState();
}

class _DetailEquipmentState extends State<DetailEquipment> with TickerProviderStateMixin {
  ...
  TextEditingController controllerCutleries = TextEditingController();
                          ...
                          builder: (context) {
                            return ButtonTheme(
                              ...
                              child: RaisedButton(
                                ...
                                onPressed: () {
                                  if (cutleriesArray.length == 0 ||saldoAwalArray.length == 0 ||penambahanArray.length == 0 ||penguranganArray.length == 0 ||saldoAkhirArray.length == 0 ||saldoFisikArray.length == 0 ||selisihArray.length == 0 || arrayKualitas.length == 0) {
                                    ...
                                    if (_isProccess == false) {
                                      ...
                                      DocumentReference docReference = Firestore.instance.collection('audit_internalDetail-cutleries').document();

                                      docReference.setData({
                                        'docRef': widget.index,
                                        'cutleries': cutleriesArray,
                                  ...
                                  child: Container(
                                    ...
                                    child:  Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: <Widget>[
                                          Flexible(child: Text('1. Cutleries', style: TextStyle(fontSize: 16.0, color: Colors.black38),),),
                                          Flexible(
                                            child: Container(
                                              height: 35.0,
                                              child: TextField(
                                                ...
                                                controller: controllerCutleries,
                                    ...
                                    Padding(
                                      ...
                                      child: ButtonTheme(
                                        ...
                                        child: OutlineButton(
                                          ...
                                          onPressed: () {
                                            setState(() {
                                              cutleriesArray.add(controllerCutleries.text);
                                ...
                                children: <Widget>[
                                  ...
                                  Flexible(
                                    child: ListView.builder(
                                      itemCount: cutleriesArray.length,
                                                ...
                                                child:  Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Flexible(child: Text(cutleriesArray[index], style: TextStyle(fontSize: 16.0, color: Colors.black, fontWeight: FontWeight.w700),),),
                                                    ],
                                                  ),
                                                ),
                                              ),
