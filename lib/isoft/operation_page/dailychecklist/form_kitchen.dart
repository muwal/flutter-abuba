...
class _FormKitchenState extends State<FormKitchen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    setState(() {
      ...
      Firestore.instance.collection('groomingPelayanan').snapshots().listen((data) {
        jumlahGroomingPelayanan = data.documents[0].data['pertanyaan'].length;
        pertanyaanGroomingPelayanan = data.documents[0].data['pertanyaan'];
      });
                            ...
                            child: ListView(
                              children: <Widget>[
                                          ...
                                          IconButton(
                                            ...
                                            onPressed: () async {
                                              ...
                                              await ImagePicker
                                                  ...
                                                  source:
                                                  ImageSource.camera, maxHeight: 400.0, maxWidth: 400.0);
                                              imageGroomingPelayanan1 =
                                                  selectedImage;
                                              filenameGroomingPelayanan1 =
                                                  basename(
                                                      imageGroomingPelayanan1
                                                          .path);
                                              ...
                                              setState(() {
                                                imageGroomingPelayanan =
                                                    filenameGroomingPelayanan1;
                                                imageGroomingPelayananBantu =
                                                    imageGroomingPelayanan1;
                                                imageGroomingPelayananSave = url;

                                                print(imageGroomingPelayanan);
                                                print(imageGroomingPelayananBantu);
                                                print(imageGroomingPelayananSave);
                                              });
                                            },
                                          ),
                                        ],
                                ...
                                ListView(
                                    shrinkWrap: true,
                                    physics: ScrollPhysics(),
                                    children: List.generate(pertanyaanGroomingPelayanan.length, (index) {
                                      indexGroomingPelayanan = index;
                                      String counter = (index + 1).toString();
                                      if (scoreGroomingPelayanan.length <
                                          jumlahGroomingPelayanan) {
                                        for (int a = 0;
                                        a < jumlahGroomingPelayanan;
                                        a++) {
                                          scoreGroomingPelayanan.add(2);

                                          warnaGroomingPelayanan.add('hijau');
                                        }
                                      }
                                              ...
                                              Container(
                                                ...
                                                child: Row(
                                                  children: <Widget>[
                                                    Flexible(
                                                      child: Text(
                                                        '${counter + '. ' + pertanyaanGroomingPelayanan[index]}',
                                                        style: TextStyle(
                                                            color: Colors.black54,
                                                            fontSize: 14.0),
                                                      ),
                                                      ...
                                                      child: ButtonTheme(
                                                        ...
                                                        RaisedButton(
                                                          ...
                                                          new RoundedRectangleBorder(
                                                            ...
                                                            BorderSide(
                                                              width: 1.5,
                                                              color: warnaGroomingPelayanan.length ==
                                                                  0
                                                                  ? Color.fromARGB(
                                                                  170,
                                                                  192,
                                                          ...
                                                          child: Text(
                                                            ...
                                                            style: TextStyle(
                                                                ...
                                                                color: warnaGroomingPelayanan.length ==
                                                                    ...
                                                                    205,
                                                                    50)
                                                                    : warnaGroomingPelayanan[index] == 'hijau'
                                                                    ? Colors.white
                                                                    : Color.fromARGB(170, 50, 205, 50)),
                                                            textAlign:
                                                            TextAlign
                                        ...
                                        children: <Widget>[
                                          ...
                                          IconButton(
                                            ...
                                            onPressed: () {
                                              ...
                                              DocumentReference docReference = Firestore.instance.collection('dailychecklist').document(widget.index);
                                              ...
                                              docReference.updateData({
                                                ...
                                                'grooming_score': scoreGroomingPelayanan,
                                                ...
                                                'grooming_pertanyaan': pertanyaanGroomingPelayanan,
                                                ...
                                                'grooming_image': imageGroomingPelayananSave,
