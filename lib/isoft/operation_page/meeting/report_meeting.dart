...
import 'package:flutter_abuba/isoft/operation_page/meeting/detail_report.dart';
      ...
      children: <Widget>[
        Container(
          ...
          child: Column(
            children: <Widget>[
              StreamBuilder(
                stream: Firestore.instance.collection('minutesMeeting').orderBy('dateCreated', descending: false).snapshots(),
                builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                  ...
                  return Column(
                    children: List.generate(snapshot.data.documents.length, (index) {
                      Timestamp coba = snapshot.data.documents[index].data['dateCreated'];
                      DateTime tanggalBantu = DateTime.tryParse(coba.toDate().toString());
                            ...
                            leading: Container(
                              ...
                              child: Row(
                                children: <Widget>[
                                  Flexible(
                                    child: Text(
                                      coba.toDate().toString().substring(8, 10) + '/' + coba.toDate().toString().substring(5, 7) + '/' +coba.toDate().toString().substring(0, 4),
                                      style: TextStyle(
                                        ...
                                        children: <Widget>[
                                          Flexible(
                                            ...
                                            child: RichText(
                                              ...
                                              text: TextSpan(
                                                text: snapshot.data.documents[index].data['namaMeeting'],
                                                style: TextStyle(
                                                    fontSize: 12.0,
                                                    color: Colors.black
                                                ),
                                        ...
                                        children: <Widget>[
                                          Flexible(
                                            ...
                                            child: RichText(
                                              ...
                                              overflow: TextOverflow.visible,
                                              text: TextSpan(
                                                text: 'MMT-${snapshot.data.documents[index].data['meetingNo'].toString().padLeft(4, '0')}',
                                                style: TextStyle(
                                                    fontSize: 11.0,
                                                    fontWeight: FontWeight.w300,
                                                    color: Colors.black45
                            ...
                            trailing: Container(
                              ...
                              child: ButtonTheme(
                                ...
                                child: OutlineButton(
                                  child: Text(
                                    'Report',
                                    style: TextStyle(fontSize: 13.0, color: snapshot.data.documents[index].data['statusActionPlan'].contains('OPEN') ? Colors.redAccent : AbubaPallate.menuBluebird),
                                  ),
                                  ...
                                  onPressed: () {
                                    Navigator.push(context,
                                        MaterialPageRoute(
                                            builder: (_) => DetailReport(idUser: widget.idUser, namaUser: widget.namaUser, departmentUser: widget.departmentUser, index: snapshot.data.documents[index].documentID, pesertaHadir: snapshot.data.documents[index].data['pesertaHadir'], pesertaMeeting: snapshot.data.documents[index].data['pesertaID'], pic: snapshot.data.documents[index].data['picIDNotulen'], createdNotulen: snapshot.data.documents[index].data['userCreatedNotulen'], noteActionPlan: snapshot.data.documents[index].data['noteActionPlan'])
                                        )
                                    );
                                  },
                                ),
