            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                  ...
                  padding: const EdgeInsets.only(right: 20.0, left: 20.0),
                  child: Text(
                    _progressShow ? '30%' : _badgetingShow ? '70%' : '90%',
                    style: TextStyle(color: Colors.black54, fontSize: 26.0),
                  ),
                ),
                Container(
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                Flexible(
                                  child: Text(
                                    _progressShow ? 'QC Checklist' : _badgetingShow ? 'Internal Audit' : 'Outlet Senopati',
                                    style: TextStyle(
                                ...
                                child: OutlineButton(
                                  ...
                                  onPressed: () {
                                    Navigator.push(
                                        ...
                                        MyCustomRoute(
                                            builder: (context) =>
                                                new DashboardKpiMonitoringDetail(name: _progressShow ? 'QC Checklist' : _badgetingShow ? 'Internal Audit' : 'Outlet Senopati')));
                                  },
                                ),
                              ),
                            ],
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                Flexible(
                                  child: Text(
                                    _progressShow ? 'Line Check Shifting' : _badgetingShow ? 'Mystery Shopper' : 'Outlet Bogor',
                                    style: TextStyle(
                                        color: AbubaPallate.green,
                                        fontSize: 19.0),
                                  ),
                                ...
                                child: OutlineButton(
                                  ...
                                  onPressed: () {
                                    Navigator.push(
                                        ...
                                        MyCustomRoute(
                                            builder: (context) =>
                                                new DashboardKpiMonitoringDetail(name: _progressShow ? 'Line Check Shifting' : _badgetingShow ? 'Mystery Shopper' : 'Outlet Bogor')));
                                  },
                                ),
                              ),
                            ],
                                  ...
                                  children: <Widget>[
                                    Row(
                                      ...
                                      children: <Widget>[
                                        Flexible(
                                          child: Text(
                                            _progressShow ? ' ' : _badgetingShow ? 'Corrective Action' : 'Outlet Bekasi',
                                            style: TextStyle(
                                                color: AbubaPallate.green,
                                                fontSize: 19.0),
                                          ),
                                        ...
                                        child: OutlineButton(
                                          ...
                                          onPressed: () {
                                            Navigator.push(
                                                ...
                                                MyCustomRoute(
                                                    builder: (context) =>
                                                        new DashboardKpiMonitoringDetail(name: _progressShow ? ' ' : _badgetingShow ? 'Corrective Action' : 'Outlet Bekasi')));
                                          },
                                        ),
                                      ),
                                    ],
                                        ...
                                        child: OutlineButton(
                                          ...
                                          onPressed: () {
                                            Navigator.push(
                                                ...
                                                MyCustomRoute(
                                                    builder: (context) =>
                                                        new DashboardKpiMonitoringDetail(name: 'Outlet Bekasi')));
                                          },
                                        ),
                                      ),
                                    ],
