...
class ManagementReview extends StatefulWidget {
  final int idUser;
  final String namaUser;
  final String departmentUser;
  ManagementReview({this.idUser, this.namaUser, this.departmentUser});

  @override
  _ManagementReviewState createState() => _ManagementReviewState();
}

class _ManagementReviewState extends State<ManagementReview> with TickerProviderStateMixin {
                                  ...
                                  return Column(
                                    ...
                                    children: <Widget>[
                                      index == 0
                                        ...
                                        : Container(),
                                      snapshot.data.documents[index].data['personReview'].indexWhere((dynamic result) => int.tryParse(result.toString()) == widget.idUser) >= 0
                                      ? snapshot.data.documents[index].data['personReviewStatus'][snapshot.data.documents[index].data['personReview'].indexWhere((dynamic result) => int.tryParse(result.toString()) == widget.idUser)] == 'OPEN' && snapshot.data.documents[index].data['statusApprove'] == false && snapshot.data.documents[index].data['personReview'].contains(widget.idUser) && snapshot.data.documents[index].data['finalStatus'] == 'OPEN'
                                        ? Padding(
                                                          ...
                                                          child: OutlineButton(
                                                            ...
                                                            onPressed: () {
                                                              ...
                                                              Navigator.pushReplacement(context,
                                                                MyCustomRoute(
                                                                  builder: (context) => ManagementReviewDetail(idUser: widget.idUser, namaUser: widget.namaUser, departmentUser: widget.departmentUser, index: snapshot.data.documents[index].documentID, personReview: personReview, personReviewDate: personReviewDate, indexReview: snapshot.data.documents[index].data['personReview'].indexWhere((dynamic result) => int.tryParse(result.toString()) == widget.idUser), personReviewDateUpdate: snapshot.data.documents[index].data['personReviewDate'], personReviewNote: snapshot.data.documents[index].data['personReviewNote'])
                                                                )
                                                              );
                                                            },
                                                          ),
