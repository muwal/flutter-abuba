...
class MenuRD extends StatefulWidget {
  ...
  MenuRD({this.idUser, this.namaUser, this.departmentUser});
  @override
  _MenuRDState createState() => _MenuRDState();
}

class _MenuRDState extends State<MenuRD> with TickerProviderStateMixin {
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        Navigator.push(context,
                          MyCustomRoute(
                            builder: (context) => new MenuRDdua(idUser: widget.idUser)
                          )
                        );
                      },
                      child: Column(
                            ...
                            children: <Widget>[
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    image: DecorationImage(
                                        image: AssetImage(
                                          'assets/images/isoft/r&ddua.png',
                                        ),
                                        fit: BoxFit.cover
                                    )
                                ),
