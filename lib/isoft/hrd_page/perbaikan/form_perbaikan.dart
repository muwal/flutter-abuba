...
class _FormPerbaikanState extends State<FormPerbaikan> with TickerProviderStateMixin {
  ...
  var maxidPerbaikanHRD;
  var indexPerbaikanHRD;
  ...
  void initState() {
    ...
    Firestore.instance.collection('dumper_perbaikan').snapshots().listen((data) {
      setState(() {
        maxidPerbaikanHRD = data.documents[0].data['maxid_perbaikan'] + 1;
        indexPerbaikanHRD = data.documents[0].documentID;
      });
    });
                                    ...
                                    onPressed: () {
                                      if (selectedCategory == null || selectedArea == null || selectedLokasi == null || selectedItemNo == null || selectedMasalah == null || detailMasalah.text == '') {
                                        ...
                                        if (_isProccess == false) {
                                          ...
                                          DocumentReference docReference = Firestore.instance.collection('perbaikanHRD').document();

                                          docReference.setData({
                                            'userCreated': widget.idUser,
                                            'dateCreated': DateTime.now(),
                                            'perbaikanNo': maxidPerbaikanHRD,
                                            ...
                                            DocumentReference documentReference =Firestore.instance.collection('dumper_perbaikan').document(indexPerbaikanHRD);

                                            documentReference.updateData({
                                              'maxid_perbaikan':maxidPerbaikanHRD
                                            }).then((doc2) {
                                              showDialog(
                                                    ...
                                                    child: Column(
                                                      children: <Widget>[
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Text(
                                                            'Perbaikan No. PRB-${maxidPerbaikanHRD.toString().padLeft(4, '0')}',
                                                            style: TextStyle(
                                                              fontSize: 16.0,
                                                            ),
                                                          ),
