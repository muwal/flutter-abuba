...
class DetailReportHRD extends StatefulWidget {
  DetailReportHRD({this.idUser, this.namaUser, this.departmentUser, this.index, this.rating});
  ...
  @override
  _DetailReportHRDState createState() => _DetailReportHRDState();
}

class _DetailReportHRDState extends State<DetailReportHRD> with TickerProviderStateMixin {
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    Flexible(
                                      child: Text(
                                        datePerbaikan.toDate().toString().substring(8, 10) + '/' + datePerbaikan.toDate().toString().substring(5, 7) + '/' + datePerbaikan.toDate().toString().substring(0, 4),
                                        style: TextStyle(
                                          fontSize: 13.0,
                                          color: Colors.black38,
                                          fontWeight: FontWeight.w700
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    Flexible(
                                      child: Text(
                                        dateVerifikasi.toDate().toString().substring(8, 10) + '/' + dateVerifikasi.toDate().toString().substring(5, 7) + '/' + dateVerifikasi.toDate().toString().substring(0, 4),
                                        style: TextStyle(
                                          fontSize: 13.0,
                                          color: Colors.black38,
                                          fontWeight: FontWeight.w700
