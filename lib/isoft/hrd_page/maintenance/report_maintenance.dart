                ...
                return animationController.isAnimating
                    ...
                    : Column(
                        children: <Widget>[
                          ...
                          status.where((test) => test == 'DONE').length == 0
                            ? Flexible(
                                child: Container(
                                  width: width,
...
class _DialogDetailState extends State<DialogDetail> with TickerProviderStateMixin {
  ...
  @override
  void initState() {
    Firestore.instance.collection('maintenance_HRD').document(widget.docID).snapshots().listen((data) {
      ...
      if (tglDone == '-') {
        ...
        if (newDueDate != '-') {
          ...
          if (tglDone == jadwal) {
            colorTglPelaksanaan = Colors.black38;
          } else if (bantuTglDone.toDate().isAfter(bantujadwal.toDate())) {
            colorTglPelaksanaan = Colors.redAccent;
          } else {
            colorTglPelaksanaan = Colors.black38;
          }
