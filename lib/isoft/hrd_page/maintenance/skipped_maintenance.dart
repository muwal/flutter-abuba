          ...
          child: Scaffold(
              ...
              appBar: AppBar(
                ...
                title: Row(
                  ...
                  children: <Widget>[
                    Flexible(
                      child: Text('Reschedule Task', style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w600, color: Colors.black),),
                    )
                  ],
                ),
              ),
                            ...
                            onPressed: () {
                              setState(() {
                                if (newDueDate == null) {
                                  ...
                                  if (isProses == false) {
                                    isProses = true;
                                    DocumentReference docReference = Firestore.instance.collection('maintenance_HRD').document(widget.docID);
