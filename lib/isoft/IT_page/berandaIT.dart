                                ...
                                children: <Widget>[
                                  Stack(
                                    ...
                                    children: <Widget>[
                                      ...
                                      StreamBuilder(
                                        stream: Firestore.instance.collection('maintenance_HRD').where('rescheduleBy', isEqualTo: widget.idUser).where('status', isEqualTo: 'SKIP').where('newDueDate', isNull: true).snapshots(),
                                      ...
                                      StreamBuilder(
                                        stream: Firestore.instance.collection('maintenance_HRD').where('pic', isEqualTo: widget.idUser).where('status', isEqualTo: 'OPEN').where('dueDate', isEqualTo: DateTime.now()).snapshots(),
                                        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                                          if (snapshot.data == null) return Container();
                                      ...
                                      StreamBuilder(
                                        stream: Firestore.instance.collection('maintenance_HRD').where('pic', isEqualTo: widget.idUser).where('status', isEqualTo: 'RESCHEDULE').where('newDueDate', isEqualTo: DateTime.now()).snapshots(),
                                        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                                          if (snapshot.data == null) return Container();
