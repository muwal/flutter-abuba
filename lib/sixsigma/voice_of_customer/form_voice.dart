...
class _FormVoiceState extends State<FormVoice> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    Firestore.instance
        .collection('dumper_voiceCustomer')
        .snapshots()
        .listen((data) {
      setState(() {
                                  ...
                                  children: <Widget>[
                                    ...
                                    ListTile(
                                      ...
                                      trailing: IconButton(
                                        ...
                                        onPressed: () {
                                          setState(() {
                                            if (_whoSelectedID.contains(
                                                int.tryParse(_whoSelection))) {
                                            } else {
                                              _whoSelectedID.add(
                                                  int.tryParse(_whoSelection));
                                            }
                                            if (_whoSelectedName
                                                .contains(_whoSelection2)) {
                                            } else {
                                              _whoSelectedName
                                                  .add(_whoSelection2);
                                            }
                                    ...
                                    Container(
                                      height: _whoSelectedName.length == 0
                                          ? null
                                                                                ...
                                                                                children: <Widget>[
                                                                                  Container(
                                                                                    ...
                                                                                    child: Center(
                                                                                      child: Text(
                                                                                        'SUCCESSFUL!',
                                                                                        style: TextStyle(color: Colors.white, fontSize: 17.0, fontWeight: FontWeight.w700),
                                                                                      ),
                                                                                    ),
                                                                                  ),
                                                                                  SizedBox(
