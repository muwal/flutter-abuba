...
class _FormVoiceState extends State<FormVoice> with TickerProviderStateMixin {
  List<Map> _listData = [
    {'nomor': '1', 'title': '1. Customer Identity', 'title_dalam': 'Who is the customer ?', 'select': 'true', 'save': 'false'},
    {'nomor': '2', 'title': '2. Voice Of The Customer', 'title_dalam': 'What did the customer say ?', 'select': 'false', 'save': 'false'},
    {'nomor': '3', 'title': '3. Key Customer Issues', 'title_dalam': 'What does the customer need ?', 'select': 'false', 'save': 'false'},
    {'nomor': '4', 'title': '4. Critical Customer Requirement', 'title_dalam': 'What resulting action is required ?', 'select': 'false', 'save': 'true'},
  ];
