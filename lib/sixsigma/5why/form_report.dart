            ...
            children: <Widget>[
              StreamBuilder(
                stream: showDataFiltered
                  ? Firestore.instance.collection('fiveWhys').where('dateCreated', isGreaterThanOrEqualTo: dateStart).orderBy('dateCreated', descending: false).snapshots()
                  : Firestore.instance.collection('fiveWhys').orderBy('dateCreated', descending: false).snapshots(),
                            ...
                            leading: Container(
                              ...
                              child: Row(
                                children: <Widget>[
                                  Flexible(
                                    child: Text(
                                      '5 Why No. FHY-${snapshot.data.documents[index].data['fiveWhysNo'].toString().padLeft(4, '0')}',
                                      style: TextStyle(
