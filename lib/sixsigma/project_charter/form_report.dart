            ...
            children: <Widget>[
              StreamBuilder(
                stream: showDataFiltered
                  ? Firestore.instance.collection('projectCharter').where('dateCreated', isGreaterThanOrEqualTo: dateStart).orderBy('dateCreated', descending: false).snapshots()
                  : Firestore.instance.collection('projectCharter').orderBy('dateCreated', descending: false).snapshots(),
                            ...
                            leading: Container(
                              ...
                              child: Row(
                                children: <Widget>[
                                  Flexible(
                                    child: Text(
                                      'Project Charter No. CHA-${snapshot.data.documents[index].data['projectCharterNo'].toString().padLeft(4, '0')}',
                                      style: TextStyle(
