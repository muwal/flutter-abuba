                                        ...
                                        children: <Widget>[
                                          ...
                                          Padding(
                                            ...
                                            child: DropdownButtonFormField(
                                              ...
                                              items: _whatCorrectJson
                                                  .map((Map map) {
                                                return new DropdownMenuItem(
                                                  value: map['id'].toString(),
                                                  child:
                                                      Text(map['whatCorrect']),
                                                );
                                              }).toList(),
                                            ),
                                          ),
