            ...
            children: <Widget>[
              StreamBuilder(
                stream: showDataFiltered
                  ? Firestore.instance.collection('problemSolving').where('dateCreated', isGreaterThanOrEqualTo: dateStart).orderBy('dateCreated', descending: false).snapshots()
                  : Firestore.instance.collection('problemSolving').orderBy('dateCreated', descending: false).snapshots(),
                            ...
                            leading: Container(
                              ...
                              child: Row(
                                children: <Widget>[
                                  Flexible(
                                    child: Text(
                                      'Problem Solving No. PSV-${snapshot.data.documents[index].data['problemSolvingNo'].toString().padLeft(4, '0')}',
                                      style: TextStyle(
