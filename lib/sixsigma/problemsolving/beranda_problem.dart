...
class BerandaProblem extends StatefulWidget {
  ...
  BerandaProblem({this.idUser, this.namaUser, this.departmentUser});
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MyCustomRoute(
                          builder: (context) => FormProblem(idUser: widget.idUser, namaUser: widget.namaUser, departmentUser: widget.departmentUser)));
                },
                child: Column(
