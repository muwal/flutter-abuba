...
class FormCommentIdea extends StatefulWidget {
  @override
  _FormCommentIdeaState createState() => _FormCommentIdeaState();
}

class _FormCommentIdeaState extends State<FormCommentIdea> {
  @override
