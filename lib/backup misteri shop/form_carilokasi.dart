...
class _FormCheckInState extends State<FormCheckIn> {
  ...
  void checkin() {
    ...
    Navigator.pushReplacement(context,
      MyCustomRoute(
        builder: (context) => FormSuasanaResto(idOutlet: widget.idOutlet, alamatOutlet: widget.alamatOutlet, outlet: widget.outlet, imageOutlet: widget.imageOutlet)
      )
    );
  }
...
class FormSuasanaResto extends StatefulWidget {
  ...
  final String imageOutlet;
  final String alamatOutlet;
  FormSuasanaResto({this.outlet, this.imageOutlet, this.alamatOutlet, this.idOutlet});
