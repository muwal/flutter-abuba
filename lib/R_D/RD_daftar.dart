...
import 'package:flutter_abuba/R_D/RD_daftar_detail.dart';
import 'package:flutter_abuba/beranda/beranda_appbardua.dart';
import 'package:flutter_abuba/constant.dart';

class RDdaftar extends StatefulWidget {
  RDdaftar({Key key}) : super(key: key);

  _RDdaftarState createState() => _RDdaftarState();
}

class _RDdaftarState extends State<RDdaftar> {
  final material = [
    {
      "tanggal": "17/08/2018",
    ...
    },
    {
      ...
      "category": "Alternative Material"
    },
    {
      "tanggal": "17/08/2018",
      "nama_produk": "Daging Kambing",
                    ...
                    : Flexible(
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            final String _alternativeMaterial =
                                material[index]['category'];
